...
class ComputeCGCNRWidget(ScriptedLoadableModuleWidget):
  ...
  def setup(self):
    ...
    self.inputSelector2.setToolTip( "Pick an input greyscale volume to the algorithm." )
    ...
    self.inputSelector3.setToolTip( "Pick an input greyscale volume to the algorithm." )
    ...
    self.inputSelector4.setToolTip( "Pick an input greyscale volume to the algorithm." )
...
class ComputeCGCNRLogic(ScriptedLoadableModuleLogic):
  ...
  def PrintCNRResults(self, inputVolume, *stats):
    """ Prints CNR Results for all stats computed
    """
    print("Printing results for: "),
    print inputVolume.GetName()
  ...
  def run(self, inputUrethraLabel, inputCGLabel, *inputVolumes):
    ...
    # print symmetricLesion_mean
    # #print "Symmetric Area STD: ",
    # print symmetricLesion_std
    # #print "Computed CNR: ",
    # #print abs(Lesion_mean-symmetricLesion_mean)/symmetricLesion_std
